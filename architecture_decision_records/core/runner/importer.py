...
def install(name, config_path, default_settings, **kwargs):
    ...
    Args:
      name (str): Module name to handle specially (e.g., "adr_config")
      config_path (str): Absolute path to the module in question (e.g., "/opt/adr/adr_config.py")
      default_settings (str): Settings module name to inherit settings from (e.g., "architecture_decision_records.core.settings")
    """
    global installed
